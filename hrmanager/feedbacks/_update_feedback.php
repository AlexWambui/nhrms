    ...
    <div class="container update_forms update_forms_employee">
        ...
        <form autocomplete="off" action="_update_feedback_code.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="comment" id="comment" placeholder="Comment" value="<?php echo $row['comment']?>" readonly>
            </div>
            <div class="form-group">
                <label for="reply">Reply:</label>
                <input type="text" class="form-control" name="reply" id="reply" placeholder="Reply" value="<?php echo $row['reply']?>">
            </div>
